...
power_decreasing_one_hot = np.full((data_power_decreasing.shape[0],1),0)
...
PRZ_liquid_one_hot = np.full((data_PRZ_liquid.shape[0],1),1)
...
PRZ_vaper_one_hot = np.full((data_PRZ_vaper.shape[0],1),2)
...
RCS_CL_1_one_hot = np.full((data_RCS_CL_1.shape[0],1),3)
...
RCS_CL_2_one_hot = np.full((data_RCS_CL_2.shape[0],1),4)
...
RCS_HL_1_one_hot = np.full((data_RCS_HL_1.shape[0],1),5)
...
RCS_HL_2_one_hot = np.full((data_RCS_HL_2.shape[0],1),6)
...
SG_2nd_one_hot = np.full((data_SG_2nd.shape[0],1),7)
...
SGTR60_one_hot = np.full((data_SGTR60.shape[0],1),8)
...
SGTR100_one_hot = np.full((data_SGTR100.shape[0],1),9)
