...
Data_power_decreasing = create_sequences(Data_power_decreasing)
...
Data_PRZ_liquid = create_sequences(Data_PRZ_liquid)
...
Data_PRZ_vaper = create_sequences(Data_PRZ_vaper)
...
Data_RCS_CL_1 = create_sequences(Data_RCS_CL_1)
...
Data_RCS_CL_2 = create_sequences(Data_RCS_CL_2)
...
Data_RCS_HL_1 = create_sequences(Data_RCS_HL_1)
...
Data_RCS_HL_2 = create_sequences(Data_RCS_HL_2)
...
Data_SG_2nd = create_sequences(Data_SG_2nd)
...
Data_SGTR60 = create_sequences(Data_SGTR60)
...
Data_SGTR100 = create_sequences(Data_SGTR100)
